 ...
 */
function toolNameToProcessor(toolName) {
 ...
 */
function modxTypeToJsonSchemaType(modxType) {
 ...
 */
function createProcessorTool(processor) {
    const properties = {};
    const required = [];
